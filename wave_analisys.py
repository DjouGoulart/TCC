...
def json_to_csv():
    dry_data_dir = 'data/Propagação de ondas/Secos'
    sat_data_dir = 'data/Propagação de ondas/Saturados'
    ...
    save_file = 'data/Propagação de ondas/ultrasound_waves_data.csv'
            ...
            with open(file, "r") as read_file:
                ...
                for wave in test['waves']:
                    writer.writerows([[
                        test['id'],
                        wave['id'],
                        'p' if wave['type'] == 'longitudinal' else 's',
                        'dry' if waves['waterContent'] == 0 else 'saturated',
